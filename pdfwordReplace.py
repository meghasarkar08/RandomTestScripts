...
def main():
	...
	doc = PDFDoc(input_path + r"C:\Users\megha\Documents\MeghaSarkar-DataEngineer-CoverLetter.pdf")
	...
	doc.Save(output_path + r"C:\Users\megha\Documents\MeghaSarkar-DataEngineer-CoverLetter_test.pdf", SDFDoc.e_linearized)
	doc.Close()
